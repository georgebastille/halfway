...
EXCEPTIONS_TO_RETRY = (requests.exceptions.Timeout, requests.exceptions.ConnectionError)
...
class TfLToGTFS:
    ...
    @retry( stop=stop_after_attempt(3), wait=wait_fixed(2), retry=retry_if_exception_type((EXCEPTIONS_TO_RETRY)) )
...
APP_ID = "Halfway"  # Replace with your actual app_id
APP_KEY = "21dbb2eeb688456e817278669ba2c9d4"  # Replace with your actual app_key

converter = TfLToGTFS(APP_ID, APP_KEY)
print(converter.get_routes())
# %%
print("Hello")
